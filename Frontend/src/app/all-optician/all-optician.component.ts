...
@Component({
  selector: 'app-all-optician',
  templateUrl: './all-optician.component.html',
  styleUrls: ['./all-optician.component.css']
})
export class AllOpticianComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.apiService.getAppointmentsByOptician({
      id: this.user.id,
      term:  search
