...
@Component({
  ...
  styleUrls: ['./all-optician-previous.component.css']
})
export class AllOpticianPreviousComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.apiService.getAppointmentsPreviousByOptician({
      id: this.user.id,
      term:  search
