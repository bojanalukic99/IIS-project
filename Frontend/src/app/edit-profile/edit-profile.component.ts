...
id: any;
  ...
  constructor(private dialog: MatDialog,private formBuilder: FormBuilder, private api: ApiService,  @Inject(MAT_DIALOG_DATA) public data: any,  private dialogRef: MatDialogRef<EditProfileComponent>, private router: Router, private activatedRoute: ActivatedRoute) { 
