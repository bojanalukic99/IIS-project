...
namespace ISS_BACK.Migrations
{
    ...
    [Migration("20220926185443_appForEquMig")]
    partial class appForEquMig
    {
            ...
            modelBuilder.Entity("ISS_BACK.Model.AppForEquipment", b =>
                {
                    ...
                    b.Property<long?>("RequiredEquipmentId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ISS_BACK.Model.AppForEquipment", b =>
                {
                    ...
                    b.HasOne("ISS_BACK.Model.RequiredEquipment", "RequiredEquipment")
                        .WithMany()
